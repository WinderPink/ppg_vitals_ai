...
#if !defined(TFLITE_MICRO_CMSIS_KERNEL_REGISTRATIONS_DISABLED)
#define TFLITE_MICRO_CMSIS_KERNEL_REGISTRATIONS_DISABLED
#endif

#if !defined(MVPV1_KERNELS_CONV2D_FALLBACK_ENABLED)
#define MVPV1_KERNELS_CONV2D_FALLBACK_ENABLED 1
#endif

#if !defined(MVPV1_KERNELS_MAX_POOL2D_FALLBACK_ENABLED)
#define MVPV1_KERNELS_MAX_POOL2D_FALLBACK_ENABLED 1
#endif

#if !defined(MVPV1_KERNELS_FALLBACK_ENABLED_DEFAULT)
#define MVPV1_KERNELS_FALLBACK_ENABLED_DEFAULT 0
#endif
