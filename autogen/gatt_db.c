...
{
  0xea, 0x49, 0xa4, 0x7c, 0x82, 0xeb, 0x20, 0x89, 0xce, 0x44, 0xe1, 0x56, 0xc8, 0x64, 0xc4, 0x5f, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_26) = {
  .len = 16,
  .data = { 0xfc, 0x55, 0x34, 0xb9, 0x99, 0xe9, 0x60, 0x90, 0x69, 0x41, 0x35, 0xfc, 0xcd, 0x1e, 0x27, 0xd4, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_23) = {
  ...
  .max_len = 20,
  .len = 5,
  .data = { 0x30, 0x2e, 0x30, 0x2e, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x0b, .uuid = 0x0003, .permissions = 0x823, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_10 },
  ...
  { .handle = 0x0e, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x0005 } },
  { .handle = 0x0f, .uuid = 0x0005, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_14 },
  ...
  { .handle = 0x18, .uuid = 0x0009, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_23 },
  ...
  { .handle = 0x1c, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x32, .char_uuid = 0x8000 } },
  { .handle = 0x1d, .uuid = 0x8000, .permissions = 0x821, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_28 },
  { .handle = 0x1e, .uuid = 0x000e, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x03, .clientconfig_index = 0x01 } },
};
