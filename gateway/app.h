...
/**************************************************************************//**
 * Application init hook, gọi bởi main.c trước vòng lặp super-loop.
 * Khởi tạo các module con (OLED, EAD scanner...).
 *****************************************************************************/
void app_init(void);

/**************************************************************************//**
 * Application process action hook, gọi bởi main.c trong vòng lặp super-loop.
 * Ủy quyền xử lý định kỳ cho các module con.
 *****************************************************************************/
